...
export const mockIssueTypeResponse = [
...
export const mockIssueStatusResponse = [
  {id: 1, name: "Raised"},
  {id: 2, name: "Accepted"},
...
export const mockIssueSeverityResponse = [
  {id: 1, name: "NA"},
  {id: 2, name: "P1"},
  {id: 3, name: "P2"},
  {id: 4, name: "P3"},
...
export const mockSearchIssuesResponse = {
  data: {
    sort: [],
    filters: {},
    offset: 0,
    ...
    issues: [
      ...
      {
        id: 2,
        createdAt: 1777065716,
        createdBy: 1,
        owner: "Anugus Young",
        summary: "let's all be thunderstruck",
        description: "A rock hit song from the Doors from the early 90s",
        module:1,
        issue_type: 1,
        issue_severity: 1,
        issue_status: 1,
      ...
      {
        id: 3,
        createdAt: 1777067416,
        createdBy: 1,
        owner: "Chris Rea",
        summary: "All roads lead to hell",
        description: "A pop rock hit song  from the early 90s",
        module:1,
        issue_type: 1,
        issue_severity: 1,
        issue_status: 1,
